...
export default function SalesChart() {
  ...
  const [xAxis, setXaxis] = useState(["08:00-09:00","09:00-10:00","10:00-11:00","11:00-12:00","12:00-13:00","13:00-14:00","14:00-15:00","15:00-16:00","16:00-17:00"]);
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="inline-flex space-x-32 w-4/6 py-8">
        ...
        <div className="inline-flex items-center justify-center">
          Time range: <MenuSimple options={["today", "this week", "last week"]} /*setStatus={setSelectedTimeRange()}*/ />
        </div>

        <button className="drop-shadow-lg bg-orange-500 p-3 px-8 rounded-full text-orange-100" onClick={handleClick()}>
          Generate
        </button>
      </div>
