import { changeAccWindow } from "@/lib/features/windows/windowsSlice";
import { useDispatch } from "react-redux";

export default function EditRelatedAccount() {
  const dispatch = useDispatch();
  return (
    <div className="absolute z-50 w-2/6 h-3/6 bg-orange-200 border-2 border-orange-400 mt-32">
      <h2 className="text-center text-3xl mt-5">Edit related account</h2>
